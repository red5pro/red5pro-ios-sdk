Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0-release.b5.red5cloud'
  ...
  s.source           = { 
    :http => 'https://github.com/red5pro/red5pro-ios-sdk/releases/download/1.0.0/Red5WebRTCKit-1.0.0-release.b5.red5cloud.xcframework.zip'
  }
