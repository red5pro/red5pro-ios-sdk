Pod::Spec.new do |s|
  ...
  # Source location - auto-generated by setup-distribution-simple.sh
  s.source           = { 
    :http => 'https://github.com/red5pro/red5pro-ios-sdk/releases/download/2.1.0.2/Red5WebRTCKit-2.1.0.2-release.b12.red5cloud.xcframework.zip'
  }
